...
wide <- read.csv("../Rpackage/inst/extdata/HD_M_FBgn0000008.csv", stringsAsFactors = FALSE)
print(wide)

evog <- EvoGeneX()
evog$setTree("../Rpackage/inst/extdata/drosophila9.newick")
evog$setRegimes("../Rpackage/inst/extdata/regime_global.csv")

ou_res <- evog$fit(wide, alpha = 0.1, gamma = 0.01)
print(ou_res)

brown <- Brown()
brown$setTree("../Rpackage/inst/extdata/drosophila9.newick")
